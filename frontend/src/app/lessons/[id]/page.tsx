...
const lessons = [
  {
    ...
    description:
      '初回限定の無料体験レッスンです。あなたの英語レベルをチェックし、最適な学習プランをご提案します。',
    detailedDescription: `
  ...
  },
  {
    ...
    description:
      '最大4名の少人数グループで行う英会話レッスン。他の生徒との交流を通じて、実践的なコミュニケーション力を身につけます。',
    detailedDescription: `
  ...
  },
  {
    ...
    description:
      '講師と1対1で行う完全個別指導レッスン。あなたの目標や弱点に合わせてカスタマイズされたレッスンを提供します。',
    detailedDescription: `
          ...
          <Container>
            <div className="grid items-center gap-12 lg:grid-cols-2">
              ...
              <div>
                ...
                <Badge
                  variant={getTypeBadgeVariant(lesson.type)}
                  className="mb-4"
                >
                ...
                <div className="mb-6 grid grid-cols-2 gap-6">
                  <div>
                    <span className="block text-primary-100">料金</span>
                    <span className="text-2xl font-bold">{formatPrice()}</span>
                    {lesson.price.originalPrice && (
                      <span className="ml-2 text-primary-200 line-through">
                        ¥{lesson.price.originalPrice.toLocaleString()}
                      </span>
                    )}
                  </div>
                  <div>
                    <span className="block text-primary-100">時間</span>
                  ...
                  {lesson.maxStudents && (
                    <div>
                      <span className="block text-primary-100">定員</span>
                      <span className="text-2xl font-bold">
                  ...
                  <div>
                    <span className="block text-primary-100">対象レベル</span>
