  ...
  if (variant === 'compact') {
    return (
      <div className={cn('rounded-lg bg-white p-6 shadow-sm', className)}>
        <h3 className="mb-4 text-lg font-bold text-gray-900">アクセス</h3>
          ...
          <div className="flex items-start space-x-3">
            ...
            <div>
              <p className="font-medium text-gray-900">
                {accessInfo.address.prefecture}
                {accessInfo.address.city}
                {accessInfo.address.street}
              </p>
      ...
      <Container>
        ...
        <div className="grid gap-12 lg:grid-cols-2">
          ...
          <div className="space-y-8">
            {/* 基本情報 */}
            <Card className="p-6">
              <h3 className="mb-6 text-xl font-bold text-gray-900">基本情報</h3>
            ...
            <Card className="p-6">
              <div className="mb-4 flex items-center justify-between">
                ...
                <Badge
                  variant={
                    currentStatus.status === 'open' ? 'success' : 'error'
                  }
                  className="text-sm"
                >
                  {currentStatus.text}
        ...
        <Card className="mt-12 p-8">
          ...
          <div className="rounded-lg bg-gray-50 p-6">
            <div className="mb-4 flex items-center">
              ...
              <h4 className="text-lg font-semibold text-gray-900">
                {accessInfo.access[selectedAccess].station}から
                {accessInfo.access[selectedAccess].walkTime}
              </h4>
            </div>

            <ol className="space-y-2">
              {accessInfo.access[selectedAccess].directions.map(
                (direction, index) => (
                  <li key={index} className="flex items-start">
                    <span className="mr-3 mt-0.5 flex h-6 w-6 flex-shrink-0 items-center justify-center rounded-full bg-primary-600 text-sm font-medium text-white">
                      {index + 1}
                    </span>
          ...
          <div className="mt-6 rounded-lg border border-yellow-200 bg-yellow-50 p-4">
            <div className="flex items-start">
              <svg
                className="mr-2 mt-0.5 h-5 w-5 text-yellow-600"
                fill="currentColor"
                viewBox="0 0 20 20"
              >
                <path
