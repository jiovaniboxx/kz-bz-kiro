...
const allLessons: Lesson[] = [
  ...
  },
  {
    ...
    description:
      'ビジネスシーンで必要な英語スキルを習得するレッスン。プレゼンテーション、会議、交渉など実践的な場面を想定した内容です。',
    type: 'group',
    level: ['中級', '上級'],
    price: {
      amount: 3500,
  ...
  },
  {
    ...
    description:
      'TOEIC L&Rテストのスコアアップを目指す集中対策レッスン。効率的な解法テクニックと実践問題で確実にスコアを向上させます。',
    type: 'group',
    level: ['初級', '中級', '上級'],
    price: {
      amount: 3000,
  ...
  },
  {
    ...
    description:
      'ご自宅から参加できるオンライン英会話レッスン。通学時間を節約しながら、質の高いレッスンを受講できます。',
    type: 'online',
    level: ['初心者', '初級', '中級', '上級'],
    price: {
      amount: 2000,
...
export function LessonsGridSection({ className }: LessonsGridSectionProps) {
  ...
  useEffect(() => {
    let filtered = allLessons.filter(lesson => {
      ...
      const matchesLevel =
        selectedLevel === 'all' || lesson.level.includes(selectedLevel);
          ...
          {filteredLessons.map((lesson, index) => (
            ...
            >
              ...
              <div className="absolute left-4 top-4 z-10 flex flex-col gap-2">
                ...
                {lesson.popular && <Badge variant="warning">人気</Badge>}
              ...
              <div className="absolute right-4 top-4 z-10">
                <div className="rounded-lg bg-white/95 px-3 py-2 backdrop-blur-sm">
              ...
              <div className="p-6">
                ...
                <div className="flex gap-2">
                  <Button
                    ...
                    asChild
                  >
                    <Link href={`/lessons/${lesson.id}`}>詳細</Link>
                  </Button>
