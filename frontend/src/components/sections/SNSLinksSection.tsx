...
export function SNSLinksSection({
  ...
  // SNSリンクのクリック追跡
  const handleSNSClick = (platform: string, url: string | undefined) => {
    if (!url) {
      console.warn(`URL not provided for ${platform}`);
      return;
    }
        ...
        <div className="flex space-x-2">
          <Button
            ...
            onClick={() =>
              handleSNSClick(
                'LINE',
                `https://line.me/R/ti/p/@${snsConfig.lineId}`
              )
            }
          >
            LINE
        ...
        <div className="grid gap-8 md:grid-cols-2 lg:grid-cols-3">
          ...
          <Card className="p-6 transition-shadow hover:shadow-lg">
            <div className="text-center">
              ...
              <h3 className="mb-2 text-xl font-bold text-gray-900">Facebook</h3>
              <p className="mb-4 text-gray-600">
              ...
              <div className="space-y-3">
                <Button
                  ...
                  onClick={() =>
                    handleSNSClick('Facebook', snsConfig.facebookUrl)
                  }
                >
                  ページをフォロー
                </Button>
                ...
                <Button
                  ...
                  onClick={() =>
                    handleSNSClick(
                      'Facebook Messenger',
                      `${snsConfig.facebookUrl}/messages`
                    )
                  }
                >
                  メッセンジャーで連絡
            ...
            <div className="text-center">
              ...
              <div className="space-y-3">
                <Button
                  ...
                  onClick={() =>
                    handleSNSClick('Instagram', snsConfig.instagramUrl)
                  }
                >
                  フォローする
                </Button>
                ...
                <Button
                  ...
                  onClick={() =>
                    handleSNSClick(
                      'Instagram DM',
                      `${snsConfig.instagramUrl}/direct/inbox/`
                    )
                  }
                >
                  DMで連絡
              ...
              <Card className="p-6">
                <div className="flex items-center space-x-4">
                  ...
                  <Button
                    ...
                    size="sm"
                    onClick={() =>
                      handleSNSClick('Twitter', snsConfig.twitterUrl)
                    }
                  >
                    フォロー
                  </Button>
              ...
              <Card className="p-6">
                <div className="flex items-center space-x-4">
                  ...
                  <Button
                    ...
                    size="sm"
                    onClick={() =>
                      handleSNSClick('YouTube', snsConfig.youtubeUrl)
                    }
                  >
                    チャンネル登録
                  </Button>
      ...
      >
        <div className="p-6 text-center">
          ...
          <div className="mt-6 space-y-3">
            <p className="text-sm text-gray-500">ID: @{snsConfig.lineId}</p>
